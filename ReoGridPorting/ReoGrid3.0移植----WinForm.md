## 一、 创建新的WinForm项目
![](Pasted%20image%2020251113222351.png)
...
![](Pasted%20image%2020251113224747.png)

## 八、解决报错
### 1. ZipArchive找不到
![](Pasted%20image%2020251113224828.png)
这个需要我们手动添加系统的引用，在Solution Explorer里右键我们项目下面的Reference
![](Pasted%20image%2020251113224937.png)
选择Add Reference
在Reference Manager界面找到我们所需要的这两个选项，勾选之后，点击OK
![](Pasted%20image%2020251113225218.png)
然后工程里面关于ZipArchive的错误就不见了
![](Pasted%20image%2020251113225254.png)

### 2. Formula 命名空间找不到
![](Pasted%20image%2020251113225337.png)
这个错误，需要我们添加一个宏定义**FORMULA**
![](Pasted%20image%2020251113225433.png)
Ctrl + S保存
这个报错也不见了
### 3. Resource  does not contain ...
![](Pasted%20image%2020251113225601.png)
这个问题需要把ReoGrid3.3目录里的Properties文件夹，复制，覆盖我们工程的Properties文件夹

### 4. NumberDataFormatter ... does not contain ...
![](Pasted%20image%2020251113225832.png)
这个问题需要我们添加一个宏定义 **LANG_JP**
我猜应该是添加小日本鬼子的支持，估计是英语学的不好吧
![](Pasted%20image%2020251113230024.png)


### 5. DateTimeFormat ... does not exist
![](Pasted%20image%2020251113230124.png)
刚刚复制过来的Properties里面有一些文件还没有被包含进项目，这里我们把相应缺失的文件包含进来即可
![](Pasted%20image%2020251113230343.png)

## 九、编译运行
至此，编译成功
![](Pasted%20image%2020251113230424.png)
然后在我们的Form1里面添加ReoGrid控件
![](Pasted%20image%2020251113230537.png)

点击运行
![](Pasted%20image%2020251113230602.png)
...
![](Pasted%20image%2020251113230900.png)
保存之后，点击编译即可生成动态库
![](Pasted%20image%2020251113231003.png)
